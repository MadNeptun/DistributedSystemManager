...
namespace MadNeptun.DistributedSystemManager.VisualSimulator.ExampleNetworks
{
    class Tree : BaseNetwork
    {
        ...
        public override List<Node<string, string>> GetNetwork(DistributedAlgorithm<string, string> algorithm, NetworkComponent<string, string> component, Node<string, string>.NodeMessage function)
        {
            ...
            tempNode1.Neighbors.Add(new NodeId<string>() { Id = "4" });
            tempNode1.Neighbors.Add(new NodeId<string>() { Id = "5" });
            ...
            tempNode3.Neighbors.Add(new NodeId<string>() { Id = "2" });
            tempNode3.Neighbors.Add(new NodeId<string>() { Id = "8" });
            ...
            tempNode4.Neighbors.Add(new NodeId<string>() { Id = "2" });
            tempNode4.Neighbors.Add(new NodeId<string>() { Id = "6" });
            tempNode4.Neighbors.Add(new NodeId<string>() { Id = "7" });
            ...
            tempNode6.Neighbors.Add(new NodeId<string>() { Id = "5" });
            ...
            tempNode7.Neighbors.Add(new NodeId<string>() { Id = "4" });
